...
const Hero: FC<HeroProps> = ({ setContactModal }) => {
  return (
    <section className="p-4 container mx-auto pt-40 flex flex-col justify-center items-center">
      ...
      <p className="text-center text-xs sm:text-xl">
        Современное оборудование и квалифицированные специалисты для ваших задач
      </p>
      <button
